    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-[var(--bg-overlay)] pt-8">
      <div className="bg-[var(--bg-surface)] rounded-xl shadow-2xl w-full max-w-md mx-4 max-h-[85dvh] flex flex-col">
        <div className="flex items-center justify-between p-4 border-b">
          <h2 className="text-lg font-bold text-[var(--text-primary)]">Reorder Crews ({items.length})</h2>
        ...
        <div className="flex gap-2 p-4 border-t">
          ...
          <button
            onClick={onClose}
            className="px-4 py-2 text-sm bg-[var(--bg-surface-alt)] text-[var(--text-primary)] rounded-lg"
          >
            Cancel
          </button>
        </div>
